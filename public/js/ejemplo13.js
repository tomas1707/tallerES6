...
const obtenerMensajeBienvenida = () =>
  "¡Bienvenidos al Taller de JavaScript ES6+!";
...
console.log(
  `El promedio de las calificaciones es: ${calcularPromedioFinal(85, 92, 100)}`,
);
...
const nuevoUsuario = crearPerfilUsuario("tomas_dev", "tomas@smartin.tecnm.mx");
